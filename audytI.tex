...
\begin{itemize*}
	...
	\item zamontowanie większej ilości kamer wokół budynku, jak wewnątrz --- zniwelowanie martwych punktów, propozycją zamontowania nowych kamer jest:
		\begin{itemize*}
			...
			\item kamera wewnętrzna w pomieszczeniu sekretariatu --- kamerę 4 zamienić na kamerę rybie oko 360 stopni Bosch Flexidome 8000, a obecną przenieść w narożnik obok switcha 2,
		\end{itemize*}
